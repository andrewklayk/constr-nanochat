    ...
    def step(self, c_val: Union[Iterable | Tensor] = None):
        ...
        for group in self.param_groups:
            ...
            for i, param in enumerate(params):
                ...
                G_i.add_(grads[i]).add_(grads[i], alpha=self._dual_vars).add_(aug_term_grads[i], alpha=self.rho).add_(param - smoothing[i],alpha=self.mu)
